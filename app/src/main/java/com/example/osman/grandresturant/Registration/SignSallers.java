...
public class SignSallers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sign_sallers);
            ...
            public void run() {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Geocoder geocoder = new Geocoder(SignSallers.this, mLocale);
        ...
        auto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (auto.getText() != ("إختيار المكان الحالى")) {
                    Toast.makeText(SignSallers.this, "يجب التأكد من تفعيل GPS والإتصال بالإنترنت", Toast.LENGTH_SHORT).show();
                } else {
                    getLocation();
                    Locale mLocale = new Locale("ar");
                    ...
                    try {
                        ...
                        Toast.makeText(SignSallers.this, countryName1, Toast.LENGTH_SHORT).show();
        ...
        spinnerCountry.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (Objects.equals(adapterView.getItemAtPosition(i).toString(), "مصر")) {
                    arrayAdaptercity = new ArrayAdapter<String>(SignSallers.this, android.R.layout.simple_dropdown_item_1line, spinnerListEgy);
                    spinnerCity.setAdapter(arrayAdaptercity);
                } else {
                    arrayAdaptercity = new ArrayAdapter<String>(SignSallers.this, android.R.layout.simple_dropdown_item_1line, spinnerListSudi);
                    spinnerCity.setAdapter(arrayAdaptercity);
                }
    ...
    private void signUp() {
        ...
        if (TextUtils.isEmpty(myEmail)) {
            ...
            HelperMethods.showDialog(SignSallers.this, "Wait...", "Create new user");
            ...
            auth.createUserWithEmailAndPassword(myEmail, myPass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    ...
                    if (!task.isSuccessful()) {
                        ...
                        Toast.makeText(SignSallers.this, "password less than 6 character !", Toast.LENGTH_SHORT).show();
                        ...
                        try {
                            ...
                            currentuser_db.child("user_tpe").setValue("company");
                            ...
                            HelperMethods.hideDialog(SignSallers.this);
                            startActivity(new Intent(SignSallers.this, User_Profile_image.class));

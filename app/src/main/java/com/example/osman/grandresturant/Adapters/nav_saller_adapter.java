...
/**
 * Created by A.taher on 4/24/2018.
 */

public class nav_saller_adapter extends RecyclerView.Adapter<nav_saller_adapter.Holder> implements Filterable {
private Context context;
        ArrayList<SallersClass> sellers;
        ArrayList<SallersClass> sellersCopy;

public nav_saller_adapter(ArrayList<SallersClass> sellers, ArrayList<SallersClass> sellersCopy, Context context) {
...
public void onClick(View v) {
    ...
    intent.putExtra("Filter", sallersClass.getId());
    ...
    public Filter getFilter() {
        return new Filter() {
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                ...
                nav_saller_adapter.this.notifyDataSetChanged();
            }
        };
    }
